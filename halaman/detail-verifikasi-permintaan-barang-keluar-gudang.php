            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Detail Verifikasi Gudang Barang Keluar</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item active">Detail Verifikasi Gudang Barang Keluar</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                                                ...
                                                if (mysqli_num_rows($query) > 0) {
                                                    while ($row = mysqli_fetch_assoc($query)) {
                                                        ...
                                                        echo '<tr>
                                                            ...
                                                            <div class="modal fade" id="id_detail' . md5($row['id_detail_permintaan_out']) . '" style="display: none;" aria-hidden="true">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form method="POST" action="config/add-verifikasi-permintaan_out.php">
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input type="text" class="form-control" id="" placeholder="" name="jumlah_permintaan_barang_out" value="' . $row['jumlah_permintaan_barang_out'] . '" hidden required>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-6">
                                                                                    ...
                                                                                    <input type="number" class="form-control" id="" name="jumlah_permintaan_barang_out" value="' . $row['jumlah_permintaan_barang_out'] . '" required readonly>
                                                                                </div>
                                                                                <div class="col-sm-6">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                    ...
                                                                                    <textarea type="text" rows="4" class="form-control" placeholder="Masukkan Keterangan" id="keterangan_out" name="keterangan_out" required></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="modal-footer justify-content-between">
                                                                          
                                                                            <button type="submit" class="btn btn-danger" value="' . $row['id_detail_permintaan_out'] . '" name="notverifikasi_detail">Tidak</button>
                                                                            <button type="submit" class="btn btn-success" value="' . $row['id_detail_permintaan_out'] . '" name="verifikasi_detail">Ya</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                <!-- /.modal-content -->
