                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 col-sm-12">
                                <a href="tambah-permintaan-brg-keluar.php"><button type="button" class="btn btn-primary" name="button"><i class="fa fa-plus"></i> Tambah Permintaan Barang Keluar</button></a>
                                <br><br>
                                <div class="card">
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                                    ...
                                                    if (mysqli_num_rows($query) > 0) {
                                                        while ($row = mysqli_fetch_assoc($query)) {
                                                            ...
                                                            <td align="center" style="">
                                                                <form class="" action="detail-permintaan-brg-out.php" method="GET">
