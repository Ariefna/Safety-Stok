...
if (isset($_POST['verifikasi_detail'])) {
    ...
    if ($query) {
        ...
        <script type="text/javascript">
            document.location = "../detail-verifikasi-permintaan-barang-keluar-gudang.php?detail=' . $kode . '&id=' . $id . '&acc=sukses";
        </script>
        ';
    } else {
        echo '
    ...
    if ($query) {
        echo '
        <script type="text/javascript">
            document.location = "../detail-verifikasi-permintaan-barang-keluar-gudang.php?detail=' . $kode . '&id=' . $id . '&tidakacc=sukses";
        </script>
        ';
    } else {
        echo '
    ...
    $sql = "UPDATE permintaan_barang_out SET status_permintaan_brg_out = 2 WHERE id_permintaan_brg_out = '$id_permintaan_brg_out'";
    $query = mysqli_query($conn, $sql);

    if ($query) {
        echo '
        <script type="text/javascript">
            document.location = "../menu-verifikasi-permintaan_gudang_out.php?save=sukses";
        </script>
        ';
    } else {
        echo '
