                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item active">Detail Pengembalian Barang</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 col-sm-12">
                                <?php
                                    $cek_status_ya = "SELECT * FROM detail_peminjaman WHERE no_peminjaman = '$no_peminjaman' AND status_peminjaman_barang = 1";
                                    $query_cek_status_ya = mysqli_query($conn, $cek_status_ya);
                                    while ($get_aja = mysqli_fetch_array($query_cek_status_ya)) {

                                        $a = $get_aja['status_pengembalian_barang'];
                                    ...
                                    ?>
                                <a href="config/add-pengembalian-barang.php?id=<?php echo $id_prt_brd; ?>">
                                    <button <?php echo $cek_but_sts; ?> type="submit" class="btn btn-success" name="save_verifikasi" value="<?php echo $id_prt_brd; ?>">
                                        <i class="fa fa-save"></i> Konfirmasi Pengembalian Barang
                                    </button>
                                </a>
                                <br><br>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                    $sql = "SELECT a.*, us.nama_user, b.nama_barang, b.no_serial, c.nama_jenis_barang, ot.id_peminjaman
                                                    ...
                                                    WHERE a.no_peminjaman = '$no_peminjaman' AND a.status_peminjaman_barang = 1";
                                                    $i = 1;
                                                    $query = mysqli_query($conn, $sql);
                                                    if (mysqli_num_rows($query) > 0) {
                                                        while ($row = mysqli_fetch_assoc($query)) {
                                                            ...
                                                            if ($row['status_pengembalian_barang'] == 0) {
                                                                $verifikasi_kembali = '<span class="right badge badge-primary">Belum Kembali</span>';
                                                            } else {
                                                                $verifikasi_kembali = '<span class="right badge badge-success">Sudah Kembali</span>';
                                                            }

                                                            if ($row['status_pengembalian_barang'] == 1) {
                                                                $but = 'disabled';
                                                            } else {
                                                                $but = '';
                                                            }
                                                            ...
                                                            <td align="center">' . $verifikasi_kembali . '</td>
                                                            ...
                                                            <div class="modal fade" id="id_detail' . md5($row['id_detail_peminjaman']) . '" style="display: none;" aria-hidden="true">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form method="POST" action="config/add-pengembalian-barang.php">
                                                                        <div class="modal-body">
                                                                            <p>Apakah Anda yakin ingin melakukan pengembalian barang ' . $row['nama_barang'] . ' ?</p>
                                                                        ...
                                                                        <div class="modal-footer justify-content-between">
                                                                            ...
                                                                            <button type="submit" class="btn btn-success" value="' . $row['id_detail_peminjaman'] . '" name="kembali_detail">Ya</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                <!-- /.modal-content -->
