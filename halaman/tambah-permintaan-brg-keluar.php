            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Tambah Permintaan Barang Kerluar</h1>
                            </div>
                            <div class="col-sm-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="example-3" class="content">
                                                ...
                                                <div class="form-group row group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="number" class="form-control" id="jumlah_permintaan_barang_out" placeholder="Masukkan Jumlah Barang .." name="jumlah_permintaan_barang_out[]" value="<?php echo $jumlah_barang; ?>" required>
                                                    </div>
                                                    <div class="col-sm-2">
