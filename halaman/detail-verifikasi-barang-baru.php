...
if ((!isset($_SESSION['appks'])) || ($_SESSION['appks'] != true)) {
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Verifikasi Pengajuan Barang</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item active">Verifikasi Pengajuan Barang</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12">
                                <?php
                                    ...
                                    ?>
                                <a href="config/add-verifikasi-barang-baru.php?id=<?php echo $no_request; ?>">
                                    <button <?php echo $cek_but_sts; ?> type="submit" class="btn btn-success" name="verifikasi_pengajuan" id="verifikasi_pengajuan">
                                        <i class="fa fa-save"></i> Konfirmasi Barang Baru
                                    </button>
                                </a>
                                <br><br>
                                <div class="card">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    WHERE a.status_request IN (0,1,2) AND a.no_request = '$get_no_req_baru'";
                                                    $i = 1;
                                                    $query = mysqli_query($conn, $sql);
                                                    if (mysqli_num_rows($query) > 0) {
                                                        while ($row = mysqli_fetch_assoc($query)) {
                                                            ...
                                                            <td align="center" style="">
                                                               <button ' . $dis . ' type="submit" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#verif' . md5($row['id_barang']) . '">
                                                                    <i class="fa fa-eye"></i>
                                                                </button>
                                                            </td>
                                                            </tr>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Kode ' . $row['no_request'] . '</h4>
                                                                        ...
                                                                        <form method="POST" action="config/add-verifikasi-barang-baru.php">
                                                                            ...
                                                                            <div class="modal-footer justify-content-between">
                                                                                <button type="submit" class="btn btn-danger" value="' . $row['id_barang'] . '" name="tidakacc">Tidak</button>
                                                                                <button type="submit" class="btn btn-primary" value="' . $row['id_barang'] . '" name="acc">Ya</button>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                    <!-- /.modal-content -->
        ...
        <?php include 'template/script.php';
            if (isset($_GET['acc']) or isset($_GET['edit']) or isset($_GET['tidakacc'])) {
                if ($_GET['acc'] == "sukses") {
                    echo '
