...
if ((!isset($_SESSION['appks'])) || ($_SESSION['appks'] != true)) {
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Data PO Barang Baru</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item active">Data PO Barang Baru</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                                                    ...
                                                    if (mysqli_num_rows($query) > 0) {
                                                        while ($row = mysqli_fetch_assoc($query)) {
                                                            ...
                                                            if ($row['status_pengajuan'] == 0) {
                                                                $status_pengajuan = '<span class="right badge badge-warning">Belum diApproved</span>';
                                                            } else {
                                                                $status_pengajuan = '<span class="right badge badge-success">Sudah diApproved</span>';
                                                            }
                                                            ...
                                                            <td align="center" style="">
                                                                <form class="" action="detail-barang-po.php" method="GET">
        ...
        <?php include 'template/script.php';
            if (isset($_GET['eval']) or isset($_GET['edit']) or isset($_GET['po_ok'])) {
                if ($_GET['eval'] == "sukses") {
                    echo '
                    ...
                    ';
                } elseif ($_GET['po_ok'] == "sukses") {
                    echo '
                    <script type="text/javascript">
                    toastr.success("Data Barang PO berhasil diKonfirmasi.");
                    </script>
                    ';
                } else {
                    echo '
